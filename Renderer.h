...
public:
    ...
    ShaderID addComputeShader(const char *filename);
    ShaderID addComputeShader(const char* filename, const char** defines, const int definesCount);
    virtual ShaderID addComputeShader(const char* src, const char** difenes, const int nDefines, const char* filename) = 0;
